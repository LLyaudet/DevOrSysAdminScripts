...
common_build_and_checks(){
  ...
  LFBFL_file_path="./${LFBFL_subdir}/${LFBFL_file_name}"
  local LFBFL_correct_sha512
  LFBFL_correct_sha512='f44eec906e231a7d81e44cf3983a698779a117f209505'
  LFBFL_correct_sha512+='cea82b0427877f211b13f64f572af52dda8a5f68a23a'
  LFBFL_correct_sha512+='af07d1ba057bfb73d9ebf1323e4dfc9d065f90b'
  wget_sha512 "${LFBFL_file_path}" "${LFBFL_URL}"\
    "${LFBFL_correct_sha512}" "${LFBFL_verbose}"
  chmod +x "./${LFBFL_file_path}"
  ...
  local LFBFL_correct_sha512
  LFBFL_correct_sha512='fae14a06d509ed9bc9c0f8d849c7d6ed5acba5fe2c362'
  LFBFL_correct_sha512+='0cd3868813b3e5d3089953d948dd1e421d130c6bfcdd'
  LFBFL_correct_sha512+='a124dad248374cf44ba04469f7341f4caa38a7f'
  wget_sha512 "${LFBFL_file_path}" "${LFBFL_URL}"\
    "${LFBFL_correct_sha512}" "${LFBFL_verbose}"
  chmod +x "./${LFBFL_file_path}"
  ...
  LFBFL_file_path="./${LFBFL_subdir}/${LFBFL_file_name}"
  local LFBFL_correct_sha512
  LFBFL_correct_sha512='2bd249013a32c408a2f47d77cad0b91988ddb424cc86f'
  LFBFL_correct_sha512+='d75db06c1274ca14d9f87527b25669019058c76c6410'
  LFBFL_correct_sha512+='52b6276c203fd49c25958099eaf82a3ae24324e'
  wget_sha512 "${LFBFL_file_path}" "${LFBFL_URL}"\
    "${LFBFL_correct_sha512}" "${LFBFL_verbose}"
  chmod +x "./${LFBFL_file_path}"

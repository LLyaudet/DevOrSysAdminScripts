...
Current version: 2026-03-03

Current number of commits: 505

Current git SHA1: 1534e38a62ed970b6dee54351d8f4902d79e828f

Code lines: 9378 total lines, 8468 not empty lines, 910 empty lines.
...
\begin{verbatim}
[ 12K Mar  3 21:00]  ./
├── [4.0K Mar  3 21:00]  build_and_checks_dependencies/
...
│   ├── [4.7K Mar  3 08:41]  check_shell_scripts_indentation.libr.sh
│   ├── [3.1K Mar  3 10:22]  check_URLs.libr.sh
│   ├── [ 29K Mar  3 20:54]  common_build_and_checks.exec.sh*
...
│   ├── [ 18K Mar  3 19:03]  create_PDF.exec.sh*
│   ├── [3.3K Feb 19 18:48]  generate_from_template.libr.sh
...
│   ├── [ 10K Mar  3 20:10]  lines_filters.libr.sh
...
│   ├── [ 13K Mar  3 20:35]  strings_functions.libr.sh
│   ├── [3.4K Mar  3 10:22]  too_long_code_lines.libr.sh
│   ├── [4.2K Mar  3 17:18]  update_common_build_and_checks.exec.sh*
│   └── [5.0K Mar  3 20:41]  update_or_check_files_names_listing.exec.sh*
├── [4.0K Mar  3 20:54]  build_and_checks.exec.sh*
├── [4.0K Mar  3 21:00]  build_and_checks_variables/
...
│   ├── [ 29K Mar  3 20:54]  DevOrSysAdminScripts.tex
│   ├── [8.5K Mar  2 13:01]  DevOrSysAdminScripts.tex.tpl
│   ├── [ 13K Mar  3 20:54]  files_listing.tex.tpl
│   ├── [4.1K Mar  3 20:39]  files_names_listing.txt
...
├── [367K Mar  3 20:54]  DevOrSysAdminScripts.html
├── [333K Mar  3 20:54]  DevOrSysAdminScripts.pdf
...
├── [4.0K Mar  3 19:56]  miscellaneous/

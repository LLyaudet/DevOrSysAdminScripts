...
Current number of commits: 52

Current git SHA1: 9b46792e60f6aca2d1ba7be5847e356ad4c0f69f

Code lines: 1797 total lines, 1543 not empty lines, 254 empty lines.
...
\begin{verbatim}
[4.0K May  6 02:18]  ./
├── [4.0K May  6 02:16]  build_and_checks_dependencies/
...
│   ├── [5.3K May  6 02:16]  common_build_and_checks.sh*
│   ├── [3.8K May  6 02:02]  common_build_and_checks.sh.tpl
│   ├── [6.6K May  6 01:40]  create_PDF.sh*
│   ├── [1.6K May  6 01:40]  get_common_text_glob_patterns.sh

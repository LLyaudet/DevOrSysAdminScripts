...
common_build_and_checks(){
  ...
  LFBFL_script_download_URL="${LFBFL_dependencies_URL}/${LFBFL_file_name}"
  LFBFL_file_path="./${LFBFL_subdir}/${LFBFL_file_name}"
  LFBFL_correct_sha512='17be17020eecc0facf3d786756f32f49da160c0dcab49'
  LFBFL_correct_sha512+='611bd6dd6a961589a3023aeb7c1f72a514f0e4131569'
  LFBFL_correct_sha512+='40a537ce60cf1c9327d3808a634976ba11bd120'
  wrapped_wget_sha512

  LFBFL_file_name="too_long_code_lines.libr.sh"
  LFBFL_script_download_URL="${LFBFL_dependencies_URL}/${LFBFL_file_name}"
  LFBFL_file_path="./${LFBFL_subdir}/${LFBFL_file_name}"
  LFBFL_correct_sha512='050a4831d1502b0333c928dbec99938dcb87d26cd8b90'
  LFBFL_correct_sha512+='2e589d2d3dea27a2680037413455eac0cc46e1d4d2d1'
  LFBFL_correct_sha512+='9cf0da927c8c9e91a0508e39197103a49898fe5'
  wrapped_wget_sha512

...
Current number of commits: 576

Current git SHA1: 6b2fef0d0d72a3c5e391ef814e7391164ac34456

Code lines: 9880 total lines, 8942 not empty lines, 938 empty lines.
...
\begin{verbatim}
[ 12K Mar  9 15:37]  ./
├── [4.0K Mar  9 15:37]  build_and_checks_dependencies/
│   ├── [3.8K Mar  9 15:36]  build_and_checks.exec.sh.tpl*
│   ├── [3.8K Mar  9 15:28]  build_md_from_printable_md.exec.sh*
...
│   ├── [ 30K Mar  9 15:29]  common_build_and_checks.exec.sh*
│   ├── [ 25K Mar  9 15:13]  common_build_and_checks.exec.sh.tpl
...
│   ├── [4.2K Mar  8 21:51]  update_common_build_and_checks.exec.sh*
│   └── [5.5K Mar  9 14:39]  update_or_check_files_names_listing.exec.sh*
├── [4.0K Mar  9 15:37]  build_and_checks.exec.sh*
├── [4.0K Mar  9 15:37]  build_and_checks_variables/
...
│   ├── [ 32K Mar  9 15:37]  DevOrSysAdminScripts.tex
│   ├── [8.9K Mar  8 16:55]  DevOrSysAdminScripts.tex.tpl
│   ├── [ 14K Mar  5 17:00]  files_listing.tex.tpl
│   ├── [5.0K Mar  5 16:36]  files_names_listing.txt
...
├── [388K Mar  9 15:37]  DevOrSysAdminScripts.html
├── [348K Mar  9 15:37]  DevOrSysAdminScripts.pdf
